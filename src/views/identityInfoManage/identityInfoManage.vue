  ...
  <div class="pad_5">
    ...
    <div>
      ...
      <el-table :data="tableData" v-loading="tableLoading" border stripe style="width: 100%">
        ...
        <el-table-column prop="registeredTime" label="注册时间" :show-overflow-tooltip="true" width=""></el-table-column>
        <el-table-column prop="up_customname" label="所属上级" :show-overflow-tooltip="true" width=""></el-table-column>
        <el-table-column prop="grand_customname" label="一级推荐人" width=""></el-table-column>
        ...
        <el-table-column prop label="操作" width>
          <template slot-scope="scope">
            <el-button v-if="roleId == 1 && scope.row.idcard_check_status == 2"  @click="handle_check(scope.row)" type="text" size="small">审核</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页 -->
