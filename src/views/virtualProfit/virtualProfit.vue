  ...
  <div class="pad_5">
    ...
    <div class="query_fields pad_b_no handle_timerange">
      ...
      >
        ...
        <!-- <el-form-item label="收益类型" prop="virtual_class" label-width="68px">
          <el-select v-model="queryForm.virtual_class" placeholder="收益类型" class="wid_140">
            <el-option
        ...
        <!-- 所属机构 -->
        <el-form-item label="所属机构" prop="customid" label-width="100px">
          <el-input v-model="queryForm.city_agent_name" placeholder="所属机构" class="wid_140"></el-input>
        </el-form-item>
        ...
        <!-- 用户姓名 custom_name-->
        <el-form-item label="用户姓名" prop="custom_name" label-width="68px">
          <el-input v-model="queryForm.custom_name" placeholder="用户姓名" class="wid_140"></el-input>
        </el-form-item>
        <!-- 上级ID up_customid-->
        <!-- <el-form-item label="上级ID" prop="up_customid" label-width="68px">
          <el-input v-model="queryForm.up_customid" placeholder="上级ID" class="wid_140"></el-input>
        </el-form-item> -->

        <!-- 上级姓名 up_custom_name-->
        <el-form-item label="上级姓名" prop="up_custom_name" label-width="68px">
          <el-input v-model="queryForm.up_custom_name" placeholder="上级姓名" class="wid_140"></el-input>
        </el-form-item>
        <!-- 订单时间 -->
    ...
    <div>
      ...
      <el-table :data="tableData" v-loading="tableLoading" border stripe style="width: 100%">
        ...
        <el-table-column prop="virtual_name" label="礼物名称"  :show-overflow-tooltip="true" width></el-table-column>
        ...
        <el-table-column prop="custom_name" label="姓名" width></el-table-column>
        <el-table-column prop="" :show-overflow-tooltip="true" label="所属机构" width>
          <template slot-scope="scope">
            <el-button @click="handle_agent_name(scope.row)" type="text" size="small">{{ scope.row.city_agent_name }}</el-button>
          </template>
        </el-table-column>
        <el-table-column prop="" label="所属上级" width>
          <template slot-scope="scope">
            <el-button type="text" size="small" @click="handle_detail(scope.row,'up_customid')">{{  scope.row.up_custom_name }}</el-button>
          </template>
        </el-table-column>
        <el-table-column prop="customAmount" label="用户分成" width></el-table-column>
