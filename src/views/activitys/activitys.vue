  ...
  <div class="pad_5">
      ...
      <el-table :data="tableData" v-loading="tableLoading" border stripe style="width: 100%">
        ...
        <el-table-column prop label="操作" width>
          <template slot-scope="scope">
            ...
            <el-button v-if="scope.row.task_type == 1 " @click="removeActivitys(scope.row,'0')" type="text" size="small">移除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页 -->
    ...
    <el-dialog
      ...
      <div class="dialogBody_addPermission">
        <div class="grid-content bg-purple-dark pad_t2">
          ...
          >
            ...
            <el-form-item label="角色">
              <el-input
                v-model="detailForm.task_type_txt"
                :disabled="true"
                class="wid_140"
                placeholder
              ></el-input>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="info" @click="dialogVisible_findInfo = false;queryForm.phone ='' " size="mini">关 闭</el-button>
        <el-button type="primary" v-if="detailForm.task_type != 1" @click="handle_activitys('1')" size="mini">添加活动号</el-button>
        <!-- <el-button type="primary" v-else @click="handle_activitys('0')" size="mini">移除活动号</el-button> -->
      </span>
    </el-dialog>
    <!-- M4 dialog 充值数量 -->
    <el-dialog
...
export default {
  ...
  methods: {
    ...
    getTableDataList(pageNum) {
      ...
      this.$http
        .post(`${commonUrl.baseUrl}/customInfo/getTaskList`, param)
        .then(res => {
        ...
        this.$http
          ...
          .then(res => {
            ...
            // debugger;
              ...
              this.detailForm.task_type = result.task_type;
              this.detailForm.task_type_txt = result.task_type == 1 ? '活动号' : '非活动号';
              // 客户类别
    ...
    removeActivitys(row,type){
      ...
      this.$http
        .post(`${commonUrl.baseUrl}/customInfo/updateTaskType`, param)
        .then(res => {
          if (res.data.code == "0000") {
            this.tableLoading = false;
